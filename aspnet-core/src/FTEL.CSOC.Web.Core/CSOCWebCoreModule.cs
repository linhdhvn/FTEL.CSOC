...
using FTEL.CSOC.Web.Authentication.JwtBearer;
using FTEL.CSOC.Web.Authentication.TwoFactor;
using FTEL.CSOC.Web.Common;
using FTEL.CSOC.Web.Configuration;
using FTEL.CSOC.Web.DashboardCustomization;
using Abp.Extensions;

namespace FTEL.CSOC.Web
{
    [DependsOn(
        typeof(CSOCApplicationModule),
        typeof(CSOCEntityFrameworkCoreModule),
    ...
    public class CSOCWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CSOCWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(CSOCApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CSOCWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(CSOCWebCoreModule).Assembly);
        }
