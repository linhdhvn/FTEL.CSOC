    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_local_Countries", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "local_DistrictTypes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_local_DistrictTypes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "local_ProvinceTypes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_local_ProvinceTypes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "local_WardTypes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_local_WardTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_local_Provinces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_local_Provinces_local_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "local_Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_local_Provinces_local_ProvinceTypes_ProvinceTypeId",
                        column: x => x.ProvinceTypeId,
                        principalTable: "local_ProvinceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_local_Districts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_local_Districts_local_DistrictTypes_DistrictTypeId",
                        column: x => x.DistrictTypeId,
                        principalTable: "local_DistrictTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_local_Districts_local_Provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "local_Provinces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_local_Wards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_local_Wards_local_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "local_Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_local_Wards_local_WardTypes_WardTypeId",
                        column: x => x.WardTypeId,
                        principalTable: "local_WardTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUsers_local_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "local_Countries",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUsers_local_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "local_Districts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUsers_local_Provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "local_Provinces",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUsers_local_Wards_WardId",
                        column: x => x.WardId,
                        principalTable: "local_Wards",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_local_Districts_ProvinceId",
                table: "local_Districts",
                column: "ProvinceId");

            migrationBuilder.CreateIndex(
                name: "IX_local_Provinces_CountryId",
                table: "local_Provinces",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_local_Provinces_ProvinceTypeId",
                table: "local_Provinces",
                column: "ProvinceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_local_Wards_DistrictId",
                table: "local_Wards",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_local_Wards_WardTypeId",
                table: "local_Wards",
                column: "WardTypeId");
        }
