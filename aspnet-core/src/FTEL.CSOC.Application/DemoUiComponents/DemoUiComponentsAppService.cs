...
using FTEL.CSOC.DemoUiComponents.Dto;

namespace FTEL.CSOC.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CSOCAppServiceBase, IDemoUiComponentsAppService
    {
