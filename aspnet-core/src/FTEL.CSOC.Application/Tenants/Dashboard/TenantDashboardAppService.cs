...
using FTEL.CSOC.Tenants.Dashboard.Dto;

namespace FTEL.CSOC.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : CSOCAppServiceBase, ITenantDashboardAppService
    {
