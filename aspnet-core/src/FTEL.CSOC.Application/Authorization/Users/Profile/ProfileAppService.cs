...
using FTEL.CSOC.Authentication.TwoFactor.Google;
...
{
    [AbpAuthorize]
    public class ProfileAppService : CSOCAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("FTEL.CSOC",
