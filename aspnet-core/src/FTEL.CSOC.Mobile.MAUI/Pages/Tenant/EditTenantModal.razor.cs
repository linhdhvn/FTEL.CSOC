...
using FTEL.CSOC.Mobile.MAUI.Extensions;
using FTEL.CSOC.Mobile.MAUI.Models.Tenants;
using FTEL.CSOC.Mobile.MAUI.Shared;
using FTEL.CSOC.MultiTenancy;
using FTEL.CSOC.MultiTenancy.Dto;
using FTEL.CSOC.Validations;

namespace FTEL.CSOC.Mobile.MAUI.Pages.Tenant
{
