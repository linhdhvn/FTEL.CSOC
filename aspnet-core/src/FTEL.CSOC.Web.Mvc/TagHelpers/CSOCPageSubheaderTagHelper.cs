...
namespace FTEL.CSOC.Web.TagHelpers
{
    ...
    public class CSOCPageSubheaderTagHelper : TagHelper
    {
        ...
        public CSOCPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
