...
namespace FTEL.CSOC.Web.Startup
{
    ...
    public class CSOCWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public CSOCWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CSOCWebMvcModule).GetAssembly());
        }
