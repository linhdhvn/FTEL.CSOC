...
namespace FTEL.CSOC.EntityFrameworkCore
{
    ...
    public class CSOCEntityFrameworkCoreModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            // Configuration.EntityHistory.Selectors.Add("CSOCEntities", EntityHistoryHelper.TrackedTypes);
            // Configuration.CustomConfigProviders.Add(new EntityHistoryConfigProvider(Configuration));
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(CSOCEntityFrameworkCoreModule).GetAssembly());
        }
