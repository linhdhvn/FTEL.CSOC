...
{
    public class CSOCDbContext : AbpZeroDbContext<Tenant, Role, User, CSOCDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public CSOCDbContext(DbContextOptions<CSOCDbContext> options)
            : base(options)
        {
