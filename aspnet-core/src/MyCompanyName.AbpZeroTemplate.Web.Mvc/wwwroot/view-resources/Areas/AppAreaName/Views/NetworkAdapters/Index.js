      ...
      listAction: {
        ...
        inputFilter: function () {
          return {
            ...
            physicalAddressFilter: $('#PhysicalAddressFilterId').val(),
            iPv4AddressFilter: $('#IPv4AddressFilterId').val(),
            iPv6AddressFilter: $('#IPv6AddressFilterId').val(),
            useDHCPFilter: $('#UseDHCPFilterId').val(),
          };
        },
      },
      columnDefs: [
