      ...
      listAction: {
        ...
        inputFilter: function () {
          return {
            ...
            minCapacityFilter: $('#MinCapacityFilterId').val(),
            maxCapacityFilter: $('#MaxCapacityFilterId').val(),
            partNumberFilter: $('#PartNumberFilterId').val(),
            minSpeedFilter: $('#MinSpeedFilterId').val(),
            maxSpeedFilter: $('#MaxSpeedFilterId').val(),
