...
{
    public class Theme1UiCustomizer : UiThemeCustomizerBase, IUiCustomizer
    {
        ...
        private void ValidateSettings(ThemeSettingsDto settings)
        {
            ...
            {
                throw new UserFriendlyException(_localizationManager.GetSource(AbpZeroTemplateConsts.LocalizationSourceName).GetString("AllowAsideMinimizing_HoverableAside_Warning")
                );
            }
        }
    }
