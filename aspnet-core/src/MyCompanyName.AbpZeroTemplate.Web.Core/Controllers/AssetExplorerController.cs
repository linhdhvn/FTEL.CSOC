...
namespace MyCompanyName.AbpZeroTemplate.Web.Controllers
{
    ...
    [DisableAuditing]
    public class AssetExplorerController : AbpZeroTemplateControllerBase
    {
        ...
        [HttpPost, ActionName("DiscoverServlet")]
        [Route("discoverservlet.html")]
        public async Task<string> DiscoverServlet()
        {
            //System.IO.StreamReader streamReader = new(Request.Body, encoding: Encoding.UTF8, detectEncodingFromByteOrderMarks: false);
