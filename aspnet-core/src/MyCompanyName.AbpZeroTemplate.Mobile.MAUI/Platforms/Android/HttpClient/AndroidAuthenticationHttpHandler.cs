...
namespace MyCompanyName.AbpZeroTemplate.Mobile.MAUI.Platforms.Android.HttpClient
{
    internal sealed class AndroidAuthenticationHttpHandler : Xamarin.Android.Net.AndroidMessageHandler
    {
        ...
        // Copy of MyCompanyName.AbpZeroTemplate.ApiClient.AuthenticationHttpHandler for android override
        // -----------------------------
        ...
        // End of Copy of MyCompanyName.AbpZeroTemplate.ApiClient.AuthenticationHttpHandler for android override
        // -----------------------------
    }
}
