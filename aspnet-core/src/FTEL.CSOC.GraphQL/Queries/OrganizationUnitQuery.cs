...
using FTEL.CSOC.Core.Base;
using FTEL.CSOC.Core.Extensions;
using FTEL.CSOC.Dto;
using FTEL.CSOC.Types;

namespace FTEL.CSOC.Queries
{
    public class OrganizationUnitQuery : CSOCQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
