...
using FTEL.CSOC.Authorization.Users.Password;
using FTEL.CSOC.Configuration;
using FTEL.CSOC.EntityFrameworkCore;
using FTEL.CSOC.MultiTenancy;
using FTEL.CSOC.Web.Startup.ExternalLoginInfoProviders;

namespace FTEL.CSOC.Web.Startup
{
    [DependsOn(
        typeof(CSOCWebCoreModule)
    )]
    public class CSOCWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CSOCWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CSOCWebHostModule).GetAssembly());
        }
