...
using FTEL.CSOC.Controls;
using FTEL.CSOC.Dto;
using FTEL.CSOC.Extensions;
using FTEL.CSOC.Localization;
using FTEL.CSOC.UI;
using FTEL.CSOC.UI.Assets;
using FTEL.CSOC.Views;
using DependencyResolver = FTEL.CSOC.Core.Dependency.DependencyResolver;
...
namespace FTEL.CSOC.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "CSOC";
