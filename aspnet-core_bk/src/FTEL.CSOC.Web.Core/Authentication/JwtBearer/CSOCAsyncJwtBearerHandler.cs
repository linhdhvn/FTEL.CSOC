...
{
    public class CSOCAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public CSOCAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
