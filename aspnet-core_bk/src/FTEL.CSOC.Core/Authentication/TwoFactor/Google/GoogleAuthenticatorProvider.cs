...
namespace FTEL.CSOC.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : CSOCServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("FTEL.CSOC", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
