...
using FTEL.CSOC.Auditing.Exporting;
using FTEL.CSOC.Authorization;
using FTEL.CSOC.Authorization.Users;
using FTEL.CSOC.Dto;
using FTEL.CSOC.EntityHistory;
using EntityHistoryHelper = FTEL.CSOC.EntityHistory.EntityHistoryHelper;

namespace FTEL.CSOC.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CSOCAppServiceBase, IAuditLogAppService
    {
